...
export const ContactStation = () => {
  // Load texture
  const texture = useLoader(THREE.TextureLoader, '/textures/images/Contact_Texture.png');
  ...
  return (
    <group position={[STATIONS.contact.x, 0, STATIONS.contact.z]}>
